...
voxel observability grid (`pose_update.voxel_observability`) to find
...
from pose_update.object_dynamics import (
    ...
    *,
    ...
    Args:
        ...
        dyn: dynamics property (resolved via
            `pose_update.object_dynamics.lookup_dynamics(label)`).
